(function($) {
    $.fn.webview = function(params) {
        ...
        t.isPrivacy = false
        t.webview = $('<webview class="webview" preload="js/extensions/preload.js" webpreferences="' + pref + '" useragent="Mozilla/5.0 (Windows NT) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/58.0.3029.110 Safari/537.36 KT-Browser/7.0.1" autosize="on" style="position: absolute; top: 0; left: 0; right: 0; bottom: 0; display: flex; height: 60px; margin-top: 48px;" src="about:blank" plugins>').appendTo($(this))[0]
